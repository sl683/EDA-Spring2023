...
> Answer: Data exploration allows for deeper understanding of a dataset and make it easier to use and analyze the data later. Through data exploration, we can have a basic understanding of what variables are included in the dataset and their characteristics. Data exploration can help identify any outliers in the dataset and also the skewness of the dataset so that we can clean, transform and impute the data for better analysis. 
